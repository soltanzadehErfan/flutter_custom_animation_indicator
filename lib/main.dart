...
class WaveLoadingBubblePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Path circleClip = Path()
      ..addRRect(
          RRect.fromLTRBXY(-waveBubbleRadius, -waveBubbleRadius, waveBubbleRadius, waveBubbleRadius, waveBubbleRadius, waveBubbleRadius));
...
class WavePathHorizontal {
  WavePathHorizontal({
    ...
    this.crossAxisEndPoint = 0,
            ...
            crossAxisEndPoint != null || doClosePath == false, "if doClosePath is true you must provide an end point (crossAxisEndPoint)");
